...
//   Card(int value, String label)
//       : rank = Rank.fromValueAndLabel(value, label),
//         super(size: SipaGame.cardSize);
...
//   @override
//   String toString() => rank.label + rank.value.toString(); // e.g. "s7" or "d10"
...
//     SipaGame.cardSize.toRect(),
//     const Radius.circular(SipaGame.cardRadius),
//   );
//   static final RRect backRRectInner = cardRRect.deflate(40);
//   static final Sprite coverSprite = flameSprite();

//   void _renderBack(Canvas canvas) {
//     canvas.drawRRect(cardRRect, backBackgroundPaint);
//     canvas.drawRRect(cardRRect, backBorderPaint1);
//     canvas.drawRRect(backRRectInner, backBorderPaint2);
//     coverSprite.render(canvas,
//         position: size / 2, size: size / 2, anchor: Anchor.center);
//   }
...
//   //     BlendMode.srcATop,
//   //   );
//   // static final Sprite redJack = cardSprite(81, 565, 562, 488);
//   // static final Sprite redQueen = cardSprite(717, 541, 486, 515);
//   // static final Sprite redKing = cardSprite(1305, 532, 407, 549);
//   // static final Sprite blackJack = cardSprite(81, 565, 562, 488)
//   //   ..paint = blueFilter;
//   // static final Sprite blackQueen = cardSprite(717, 541, 486, 515)
//   //   ..paint = blueFilter;
//   // static final Sprite blackKing = cardSprite(1305, 532, 407, 549)
//   //   ..paint = blueFilter;

//   void _renderFront(Canvas canvas) {
//     canvas.drawRRect(cardRRect, frontBackgroundPaint);

//     Sprite sprite = cardSprite(rank.path);

//     sprite.render(
//       canvas,
//       position: Vector2(size.x / 2, size.y / 2),
//       anchor: Anchor.center,
//       size: sprite.srcSize.scaled(4.5),
//     );

//     // final rankSprite = suit.isBlack ? rank.blackSprite : rank.redSprite;
//     // final suitSprite = suit.sprite;
//     // _drawSprite(canvas, rankSprite, 0.1, 0.08, scale: 0.4);
//     // _drawSprite(canvas, suitSprite, 0.1, 0.18, scale: 0.3);
//     // _drawSprite(canvas, rankSprite, 0.1, 0.08, rotate: true);
//     // _drawSprite(canvas, suitSprite, 0.1, 0.18, scale: 0.3, rotate: true);
